...
//using static io.openinstall.unity.OpenInstall;
...
public static class CCUGenConfig {
    ...
    public static List<List<string>> BlackList = new List<List<string>>()  {
        ...
        new List<string>() { "Febucci.UI.Core.BehaviorBase", "EDITOR_RecordModifier", "System.String", "System.String"},
        new List<string>() { "Febucci.UI.Core.BehaviorBase", "EDITOR_ApplyModifiers"},
    };
    ...
    public static List<Type> others = new List<Type>()
    {
        ...
        //typeof(DDOLSingleton<CoroutineController>),
        //typeof(DDOLSingleton<AudioManager>),
        //typeof(DDOLSingleton<NetController>),
        //typeof(DDOLSingleton<SMSSDKManager>),

        //typeof(Singleton<MessageCenter>),
        //typeof(Singleton<UIManager>),
        //typeof(Singleton<ResManager>),
        //typeof(Singleton<ModuleManager>),

        //typeof(BaseLuaBehaviour<ColliderLuaBehaviour>),
        //typeof(BaseLuaBehaviour<DestroyLuaBehaviour>),
        //typeof(BaseLuaBehaviour<DownloadLuaBehaviour>),
        ...
        //typeof(Com.TheFallenGames.OSA.Core.OSA<OSAScrollView.Param, OSAScrollView.ItemViewHolder>),
        typeof(Com.TheFallenGames.OSA.Core.BaseItemViewsHolder),
        typeof(Com.TheFallenGames.OSA.Core.AbstractViewsHolder),
        //typeof(OSAScrollView.OSAScrollView),
        //typeof(OSAScrollView.Param),
        //typeof(OSAScrollView.ItemViewHolder),
        typeof(TextAnchor),
        // add 
    ...
    static List<Type> LuaCallCSharpAndCSharpCallLua = new List<Type>() {
        ...
        //typeof(JBPROTO.NetComponentImpl),
